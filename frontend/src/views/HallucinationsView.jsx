      ...
      <div className="glass-panel p-6 sm:p-8 rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-dark-850 shadow-sm space-y-6">
        ...
        <div className="flex flex-wrap items-center gap-2 border-b border-slate-200 dark:border-slate-800 pb-4">
          ...
          <button
            ...
            className="px-3 py-1.5 rounded-md bg-slate-100 hover:bg-orange-50 dark:bg-dark-900 dark:hover:bg-orange-500/10 text-slate-800 dark:text-slate-200 border border-slate-200 dark:border-slate-700 hover:border-primary/40 text-xs font-semibold transition-colors shadow-sm"
          >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div>
              ...
              <textarea
                ...
                required
                className="w-full bg-slate-50 dark:bg-dark-900 border border-slate-300 dark:border-slate-700 rounded-md p-3.5 text-xs text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary/30 shadow-sm"
              />
            </div>
        ...
        {/* Results Box */}
        {result && (
          <div className="p-6 rounded-lg bg-slate-50 dark:bg-dark-900/90 border border-slate-200 dark:border-slate-800 space-y-4 animate-fade-in">
            <div className="flex items-center justify-between flex-wrap gap-2 border-b border-slate-200 dark:border-slate-800 pb-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="px-3 py-1 rounded-md text-xs font-semibold bg-primary/10 text-primary dark:text-primary-light border border-primary/20">
            ...
            <div className="space-y-3 text-xs text-slate-700 dark:text-slate-300">
              {result.claim_verifications && result.claim_verifications.length > 0 ? (
                result.claim_verifications.map((cv, idx) => (
                  <div key={idx} className="p-3.5 rounded-md bg-white dark:bg-dark-850 border border-slate-200 dark:border-slate-800 space-y-1.5 shadow-sm">
                      ...
                      <span
                        className={`px-2 py-0.5 rounded text-[10px] font-bold ${
                          cv.is_factual
                            ...
                            : 'bg-orange-500/20 text-orange-800 dark:text-orange-200 border border-orange-500/50'
                        }`}
                      >
                    ...
                    {cv.evidence && (
                      <div className="text-slate-500 dark:text-slate-400 text-[10px] bg-slate-50 dark:bg-dark-900 p-2 rounded-md border border-slate-200 dark:border-slate-800">
