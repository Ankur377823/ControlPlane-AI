    ...
    <div className="space-y-6 animate-fade-in">
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                required
                className="w-24 bg-slate-50 dark:bg-dark-900 border border-slate-300 dark:border-slate-700 rounded-xl px-3 py-2.5 text-xs text-slate-900 dark:text-white focus:outline-none focus:border-primary shadow-sm"
              />
              <button
                type="submit"
                disabled={submitting}
                className="flex-1 py-2.5 rounded-xl bg-primary hover:bg-primary-hover text-white text-xs font-bold shadow-md shadow-primary/25 transition-colors disabled:opacity-50"
              >
      ...
      <div className="glass-panel rounded-3xl overflow-hidden border border-slate-200 dark:border-slate-800 bg-white dark:bg-dark-850 shadow-sm">
        <div className="p-4 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between">
          ...
          <button
            onClick={loadTokens}
            className="p-1.5 bg-slate-100 hover:bg-slate-200 dark:bg-dark-800 dark:hover:bg-dark-700 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 rounded-xl transition-colors text-xs flex items-center gap-1 font-medium shadow-sm"
          >
                    ...
                    <tr key={tok.id} className="hover:bg-slate-50/80 dark:hover:bg-dark-900/50 transition-colors">
                      ...
                      <td className="py-3.5 px-4 text-right space-x-1.5">
                        <button
                          ...
                          className="px-2.5 py-1 rounded-lg bg-slate-100 hover:bg-slate-200 dark:bg-dark-800 dark:hover:bg-dark-700 text-slate-800 dark:text-slate-200 border border-slate-200 dark:border-slate-700 text-[11px] font-medium transition-colors inline-flex items-center gap-1 shadow-sm"
                        >
                        ...
                        {isAct && (
                          <button
                            ...
                            className="px-2.5 py-1 rounded-lg bg-rose-500/10 hover:bg-rose-500/20 text-rose-700 dark:text-rose-400 border border-rose-500/25 text-[11px] font-semibold transition-colors inline-flex items-center gap-1 shadow-sm"
                          >
