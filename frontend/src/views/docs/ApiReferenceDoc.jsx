...
export function ApiReferenceDoc() {
  return (
    <div className="space-y-8 animate-fade-in text-slate-800 dark:text-slate-200">
      ...
      <section id="check-endpoint" className="space-y-4 pt-4 border-t border-slate-200 dark:border-slate-800">
        ...
        <div className="space-y-2">
          <div className="text-xs font-bold text-slate-700 dark:text-slate-300 uppercase">Request Body</div>
          <pre className="text-xs font-mono text-slate-800 dark:text-emerald-300 bg-slate-50 dark:bg-dark-900 p-4 rounded-2xl border border-slate-200 dark:border-slate-800 overflow-x-auto whitespace-pre">
{`{
  ...
  "session_id": "sess_10293847"
        ...
        <div className="space-y-2 pt-2">
          <div className="text-xs font-bold text-slate-700 dark:text-slate-300 uppercase">Response Body</div>
          <pre className="text-xs font-mono text-slate-800 dark:text-emerald-300 bg-slate-50 dark:bg-dark-900 p-4 rounded-2xl border border-slate-200 dark:border-slate-800 overflow-x-auto whitespace-pre">
{`{
  ...
  "hash_chain": "a8fbc7304918e..."
      ...
      <section id="scan-endpoint" className="space-y-4 pt-4 border-t border-slate-200 dark:border-slate-800">
        <h2 className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-white font-brand flex items-center gap-2">
      ...
      <section id="hallucination-endpoint" className="space-y-4 pt-4 border-t border-slate-200 dark:border-slate-800">
        <h2 className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-white font-brand flex items-center gap-2">
