...
export function WhatIsControlPlane() {
  return (
    <div className="space-y-10 animate-fade-in text-slate-800 dark:text-slate-200">
      ...
      <section id="the-problem" className="space-y-4 pt-6 border-t border-slate-200 dark:border-slate-800">
        ...
        <ul className="space-y-3 text-[15px] text-slate-700 dark:text-slate-300 list-disc list-inside leading-relaxed pl-1">
          <li>
      ...
      <section id="core-capabilities" className="space-y-4 pt-6 border-t border-slate-200 dark:border-slate-800">
        <h2 className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-white font-brand flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
          <div className="p-5 rounded-2xl bg-white dark:bg-dark-850 border border-slate-200 dark:border-slate-800 shadow-sm space-y-2.5">
            <h3 className="font-bold text-[15px] text-slate-900 dark:text-white font-brand">Sub-15ms Fast-Path Guardrail</h3>
            <p className="text-[13.5px] text-slate-600 dark:text-slate-300 leading-relaxed font-normal">
              Deterministic regex and pattern evaluators in <code className="px-1.5 py-0.5 rounded bg-slate-100 dark:bg-dark-800 text-primary font-mono text-[12.5px]">pii.py</code>, <code className="px-1.5 py-0.5 rounded bg-slate-100 dark:bg-dark-800 text-primary font-mono text-[12.5px]">injection.py</code>, <code className="px-1.5 py-0.5 rounded bg-slate-100 dark:bg-dark-800 text-primary font-mono text-[12.5px]">bias_safety.py</code>, and <code className="px-1.5 py-0.5 rounded bg-slate-100 dark:bg-dark-800 text-primary font-mono text-[12.5px]">cost.py</code> executing under 15ms with zero model latency penalty.
            </p>
          </div>

          <div className="p-5 rounded-2xl bg-white dark:bg-dark-850 border border-slate-200 dark:border-slate-800 shadow-sm space-y-2.5">
            <h3 className="font-bold text-[15px] text-slate-900 dark:text-white font-brand">Action Risk Tiers (LOW to CRITICAL)</h3>
            <p className="text-[13.5px] text-slate-600 dark:text-slate-300 leading-relaxed font-normal">
          ...
          <div className="p-5 rounded-2xl bg-white dark:bg-dark-850 border border-slate-200 dark:border-slate-800 shadow-sm space-y-2.5">
            <h3 className="font-bold text-[15px] text-slate-900 dark:text-white font-brand">FacTool Factuality & Grounding</h3>
            <p className="text-[13.5px] text-slate-600 dark:text-slate-300 leading-relaxed font-normal">
          ...
          <div className="p-5 rounded-2xl bg-white dark:bg-dark-850 border border-slate-200 dark:border-slate-800 shadow-sm space-y-2.5">
            <h3 className="font-bold text-[15px] text-slate-900 dark:text-white font-brand">SHA-256 Tamper-Evident Audit Chain</h3>
            <p className="text-[13.5px] text-slate-600 dark:text-slate-300 leading-relaxed font-normal">
      ...
      <section id="how-it-deploys" className="space-y-4 pt-6 border-t border-slate-200 dark:border-slate-800">
        <h2 className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-white font-brand flex items-center gap-2">
          <span>Supported Integration Modes</span>
          <span className="text-primary text-lg font-normal">#</span>
        </h2>
        <div className="space-y-3 text-[15px] text-slate-700 dark:text-slate-300 leading-relaxed">
          <p>
            <strong className="text-slate-900 dark:text-white font-semibold">1. REST API Guardrail Endpoint:</strong> Intercept and sanitize user prompts before sending them to your LLM backends via <code className="px-1.5 py-0.5 rounded bg-slate-100 dark:bg-dark-800 text-primary font-mono text-[13px]">/api/v1/resources/&#123;id&#125;/check</code>.
          </p>
          <p>
            <strong className="text-slate-900 dark:text-white font-semibold">2. Botpress Connector:</strong> Direct webhook validation, probe auditing, and runtime monitoring for Botpress Cloud bots.
          </p>
          <p>
            <strong className="text-slate-900 dark:text-white font-semibold">3. Chrome Manifest V3 Extension:</strong> Zero-configuration client-side prompt interception for ChatGPT, Claude, Gemini, DeepSeek, and Kimi.
          </p>
        </div>
      </section>
    </div>
